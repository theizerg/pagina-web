...
@section('breadcrumb')
    ...
    <li><a href="{{ url('proyectos')}}">proyecto</a></li>
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-6">
          <div class="btn-group">
            @can('view_proyectos')
            <a href="{{ url('proyectos') }}" class="btn btn-primary"><i class="fa fa-plus-square"></i> Listado</a>
            @endcan
          </div>
        </div>
      </div>
                  ...
                  <td>
                    <div class="dropdown">
                      ...
                      <ul class=" dropdown-menu dropdown-menu-right">
                        @can('edit_estructura')
                        <li><a href="{{ url('proyectos',[$son->encode_id,'edit']) }}"><i class="fa fa-edit"></i> Editar</a></a></li>
                        @endcan
                      </ul>
                    </div>
                  </td>
