    ...
    <div class="row">
      <div class="col-md-6">
        <div class="btn-group">
          ...
          @endcan
          <a href="{{ url('menus', [$menus->encode_id]) }}" class="btn btn-primary"><i class="fa fa-eye"></i> Datos</a>
        </div>
      </div>
    </div>
    <br>
      ...
      <div class="col-md-12">
        <div class="box box-primary">
          <form role="form" id="main-form">
            <input type="hidden" id="_url" value="{{ url('menus', [$menus->encode_id]) }}">
            <input type="hidden" id="_token" value="{{ csrf_token() }}">
            <div class="box-body">
              <div class="form-group pading">
                <label for="nombre">Nombre del menú</label>
                <input class="form-control" id="nombre" name="nombre" value="{{ $menus->nombre }}" placeholder="Nombres">
                <span class="missing_alert text-danger" id="nombre_alert"></span>
              </div>
              <div class="form-group">
                <label for="ruta">Ruta del menú</label>
                <input class="form-control" id="ruta" name="ruta" value="{{ $menus->ruta }}" placeholder="Apellidos">
              ...
              <div class="form-group">
                ...
                <div class="checkbox icheck">
                  <label>
                    <input type="radio" name="status" value="1" {{ $menus->status == 1 ? 'checked' : '' }}> Activo&nbsp;&nbsp;
                    <input type="radio" name="status" value="0" {{ $menus->status == 0 ? 'checked' : '' }}> Deshabilitado&nbsp;&nbsp;
                  </label>
                </div>
              </div>
